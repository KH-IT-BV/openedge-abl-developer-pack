...
| -------------- | ---------------- | ------------------------------------------------------------ | ------------------- | ------------------------------------------------------------------------------ | ------------------ |
| List Databases | `#listDatabases` | Lists all databases configured in the DataDigger connection. | —                   | `database` (name filter)                                                       | 🚧 In progress |
| List Tables    | `#listTables`    | Lists all tables in the specified database.                  | `database`          | —                                                                              | 🟡 Validation 1/2         |
| Describe Table | `#describeTable` | Returns field definitions for a table.                       | `database`, `table` | —                                                                              | 🟡 Validation 1/2         |
| List Indexes   | `#listIndexes`   | Returns index definitions for a table.                       | `database`, `table` | —                                                                              | 🟡 Validation 1/2         |
| Query Table    | `#queryTable`    | Queries rows with optional filter, pagination, and sorting.  | `database`, `table` | `filter` (WHERE without keyword), `limit`, `offset`, `sortBy`, `sortAscending` | 🟡 Validation 1/2         |
| Count Table    | `#countTable`    | Returns the exact row count matching an optional filter.     | `database`, `table` | `filter`                                                                       | 🚧 In progress |
...
| Tool         | Reference      | Description                      | Required args                                                      | Optional args                                                                           | Status    |
| ------------ | -------------- | -------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------------------------------------------- | ---------- |
| Insert Row   | `#insertRow`   | Inserts a new row into a table.  | `database`, `table`, `row`, `confirm`, `reason`                    | —                                                                                       | 🟡 Validation 1/2 |
| Update Row   | `#updateRow`   | Updates an existing row.         | `database`, `table`, `originalRow`, `changes`, `confirm`, `reason` | —                                                                                       | 🟡 Validation 1/2 |
| Delete Row   | `#deleteRow`   | Deletes a row from a table.      | `database`, `table`, `row`, `confirm`, `reason`                    | —                                                                                       | 🟡 Validation 1/2 |
| Export Query | `#exportQuery` | Exports query results to a file. | `database`, `table`, `outputPath`, `confirm`, `reason`             | `where`, `format` (`XML` \| `JSON` \| `CSV` \| `TXT` \| `4GL` \| `Progress`), `options` | 🟡 Validation 1/2 |
