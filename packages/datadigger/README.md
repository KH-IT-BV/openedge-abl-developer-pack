...
# or directly:
apm install KH-IT-BV/openedge-abl-developer-pack/packages/datadigger#v0.1.0
```

## What the agent gets

A headless Node+OE backend reachable without VS Code via the launcher CLI
(`datadiggerLauncherCli.ts start`, httpPort 23004 / ablSocketPort 23001) and the backend HTTP API.
See `skills/datadigger-ai-tools/SKILL.md`.
