...
When working on OpenEdge database browsing or query tasks, prefer the `datadigger-ai-tools` skill for the `openedge-datadigger` MCP tools, the headless launcher CLI, backend HTTP API, ports, and connection settings.
